...
templates = Jinja2Templates(directory="templates_base")
...
with open("templates_base/index.html", "w") as f:
    f.write("""
<!DOCTYPE html>
<html>
<head>
    <title>Base Qwen2-VL Model Inference</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Base Qwen2-VL Model Inference</h1>
        <div class="model-info">
            <p><strong>Model:</strong> unsloth/Qwen2-VL-2B-Instruct-bnb-4bit (Base Model)</p>
            <p><strong>Note:</strong> This is the base model without fine-tuning.</p>
        </div>
        <form id="uploadForm">
            <div>
...
async def generate(
    ...
    try:
        ...
        image_path = os.path.join("uploads_base", image_filename)
...
if __name__ == "__main__":
    ...
    load_model()
    uvicorn.run(app, host="0.0.0.0", port=8001)  # Using port 8001 to avoid conflict with the fine-tuned model 